    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('STAFF', 'Hospital Staff'), ('COORDINATOR', 'Coordinator'), ('DISPATCHER', 'Dispatcher')], default='STAFF', max_length=20)),
                ...
                ('hospital', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='staff_members', to='hospitals.hospital')),
